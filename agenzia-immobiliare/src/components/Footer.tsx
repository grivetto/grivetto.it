                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3">
                            <a href="https://www.facebook.com/agenziaroyalteam/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg hover:scale-110">
                                <Facebook size={20} />
                            </a>
                            <a href="https://www.instagram.com/royalteamimmobiliare/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg hover:scale-110">
                                <Instagram size={20} />
                            </a>
                            <a href="https://wa.me/393470034777" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] rounded-full flex items-center justify-center text-white transition-all duration-300 shadow-lg hover:scale-110">
                                {/* WhatsApp Icon */}
